...
const referrer = "https://movieshdwatch.to" as const;
...
const canvas = {
  baseUrl: "https://megacloud.tv/embed-1/e-1/1hnXq7VzX0Ex?k=1",
  width: 0,
  height: 0,
  style: {
    style: {
...
const fake_window: fakeWindow = {
  ...
  location: {
    href: "https://megacloud.tv/embed-1/e-1/1hnXq7VzX0Ex?k=1",
    origin: "https://megacloud.tv",
  },
  performance: {
    timeOrigin: dateNow,
